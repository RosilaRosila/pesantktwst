                ...
                <div class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <br>
                                <form action="{{ route('fasilitas.update', $datafasilitas->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <br>
                                    <br>
                                    <a class="btn btn-warning " href="{{ route('fasilitas.index') }}" style="color: white;">
                                        Kembali
                                    </a>
