                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="m-0 text-dark" style="font-weight: bold;">Tambah Data Role</h5>
                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <br>
                                                        <strong style="border-bottom: 1px solid black;">Permission:</strong>
                                                        <br>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <br>
                                                    <br>
                                                    <a class="btn btn-warning" href="{{ route('roles.index') }}" style="color: white;">Kembali</a>
