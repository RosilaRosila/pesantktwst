            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola Role Management</h4>
                        <br>
                        <br>
                        <div class="text-end mb-5">
                            ...
                            <a class="btn btn-primary" href="{{ route('roles.create') }}">
                                <i class=" nav-icon fas fa-plus-circle"></i>&nbsp Tambah Data Role
                            </a>
                            @endcan
                        </div>
                        ...
                        <section class="content">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <form method="GET" action="{{ route('roles.index') }}" class="form-inline mb-3">
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                            <tr>
                                                <td class="text-center" colspan="3">Data Belum Tersedia</td>
                                            </tr>
                                            @endif
                                    </table>
                                    <br>
                                    <div>
                                        ...
                                        <div class="float-right">
                                            {!! $roles->appends(['perPage' => request('perPage'), 'search' => request('search')])->render() !!}
                                        </div>
                                        @else
                                        Showing all {{ $roles->count() }} entries
                                        @endif
                                    </div>
                                </div>
                            </div>
