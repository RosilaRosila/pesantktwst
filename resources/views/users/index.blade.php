            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola User Management</h4>
                        <br>
                        <br>
                        <div class="text-end mb-5">
                            ...
                            <a class="btn btn-primary" href="{{ route('users.create') }}">
                                <i class=" nav-icon fas fa-plus-circle"></i>&nbsp Tambah Data User
                            </a>
                            @endcan
                        </div>
                                ...
                                <div class="card-body table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    $hasSuperAdminRole = $user->getRoleNames()->contains('Super Admin');
                                                    @endphp
                                    ...
                                    <div>
                                        ...
                                        <div class="float-right">
                                            {!! $data->appends(['perPage' => request('perPage'), 'search' => request('search')])->render() !!}
                                        </div>
                                        @else
                                        Showing all {{ $data->count() }} entries
                                        @endif
                                    </div>
                                </div>
                            </div>
