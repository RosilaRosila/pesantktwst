        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('review.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $wisata->title }}" readonly style="font-size: 12px;">
                        <!-- Hidden input to store the datawisataid in the form -->
                        <input type="hidden" name="datawisataid" value="{{ $wisata->id }}">
                    </div>
                    <div class="row mt-4">
                        <div class="col-sm-6">
                            <div class="form-group">
            ...
            <div class="card-body">
                <form action="{{ route('review.store2') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="txtname" class="form-label"><b>Nama Tempat Wisata<span style="color: red;">*</span></b></label>
                        <input type="text" class="form-control" value="{{ $wisata2->title }}" readonly style="font-size: 12px;">
                        <!-- Hidden input to store the datawisataid in the form -->
                        <input type="hidden" name="datawisataid2" value="{{ $wisata2->id }}">
                    </div>
                    <div class="row mt-4">
                        <div class="col-sm-6">
                            <div class="form-group">
