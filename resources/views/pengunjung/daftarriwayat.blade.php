...
<div class="card mt-5" style="width:85%; margin:0 auto">
    ...
    <div class="card-body table-responsive">
        ...
        <section class="content mt-3">
            ...
            <div class="alert alert-danger" style="color: red; font-weight:bold; font-size:10px">
                <p><u>Informasi Penting <span style="color: red;">*</span></u></p>
                <p>Tiket dapat diunduh dengan cara pilih detail pemesanan-> print tiket wisata</p>
            </div>

            <br>

            @if($pesan->count() > 0)
            @foreach($pesan as $tiket)
            <div class="card">
                <div class="card-body">
                    ...
                    <p style="font-size: 12px; font-weight: bold;">
                        <label class="label {{ ( $tiket->kehadiran == 0) ? 'text-danger' : 'text-success' }}">
                            @if($tiket->kehadiran == 0)
                            <i class="fas fa-exclamation-circle"></i> <!-- Icon for 'Belum Digunakan' -->
                            Tiket Belum Digunakan
                            @else
                            <i class="fas fa-check-circle"></i> <!-- Icon for 'Sudah Digunakan' -->
