        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('review.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $wisata3->title }}" readonly style="font-size: 12px;">
                        <!-- Hidden input to store the datawisataid in the form -->
                        <input type="hidden" name="datawisataid" value="{{ $wisata3->id }}">
                    </div>
                    <div class="row mt-4">
                        <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <div class="star-rating" id="rating1" style="font-size: 12px;">
                                ...
                                <input type="hidden" name="rating" id="rating-value1" required>
                            </div>
            ...
            <div class="card-body">
                <form action="{{ route('review.store2') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="txtname" class="form-label"><b>Nama Tempat Wisata<span style="color: red;">*</span></b></label>
                        <input type="text" class="form-control" value="{{ $wisata4->title }}" readonly style="font-size: 12px;">
                        <!-- Hidden input to store the datawisataid in the form -->
                        <input type="hidden" name="datawisataid2" value="{{ $wisata4->id }}">
                    </div>
                    <div class="row mt-4">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="txtname" class="form-label"><b>Nama <span style="color: red;">*</span></b></label>
                                <input type="name" class="form-control form-control" id="txtname" name="name2" value="{{ Auth::guard('pengunjung')->user()->name }}" readonly style="font-size: 10px;">
                            </div>
                            <div class="form-group">
                                <label for="txtemail" class="form-label"><b>Email <span style="color: red;">*</span></b></label>
                                <input type="email" class="form-control form-control" id="txtemail" name="email2" value="{{ Auth::guard('pengunjung')->user()->email }}" readonly style="font-size: 10px;">
                            </div>
                            <div class="form-group mt-4">
                                <label for="rating"><b>Rating <span style="color: red;">*</span> : &nbsp </b></label>
                                <div class="star-rating" id="rating2" style="font-size: 12px;">
                                    <i class="fas fa-star" data-value="1"></i>
                                    <i class="fas fa-star" data-value="2"></i>
                                    <i class="fas fa-star" data-value="3"></i>
                                    <i class="fas fa-star" data-value="4"></i>
                                ...
                                <input type="hidden" name="rating2" id="rating-value2" required>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="txtreview" class="form-label"><b>Masukan Ulasan Anda <span style="color: red;">*</span></b></label>
                                <textarea type="text" class="form-control form-control" id="txtreview" placeholder="Masukan Ulasan Anda" name="review2" style="height: 150px; font-size: 10px;"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="d-grid gap-1 mt-4">
...
<script>
    $(document).ready(function() {
        ...
        $('.star-rating .fa-star').on('click', function() {
            ...
            $('#rating1 i').on('click', function() {
                $('#rating-value1').val($(this).data('value'));
            ...
            $('#rating2 i').on('click', function() {
                $('#rating-value2').val($(this).data('value'));
                // Reset tampilan bintang
                $('.fa-star').removeClass('checked');
