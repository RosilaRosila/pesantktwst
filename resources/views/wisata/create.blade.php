                ...
                <div class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <br>
                                <form action="{{ route('datawisata.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mt-5">
                                        <label class="form-label" style=" font-weight:normal; border-bottom: 2px solid black;">Tambahkan Fasilitas Wisata</label>
                                        @php $i=0; @endphp
                                        @foreach($all_fasilitas as $fs)
                                        @php $i++; @endphp
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="{{ $fs->id }}" id="defaultCheck{{ $i }}" name="arr_fasilitas[]">
