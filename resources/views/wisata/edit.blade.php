                ...
                <div class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <br>
                                <form action="{{ route('datawisata.update', $datawisatas->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mt-5">
                                        <label class="form-label" style=" font-weight:normal; border-bottom: 2px solid black;">Fasilitas Wisata</label>
                                        @php $i=0; @endphp
                                        @foreach($all_fasilitas as $fs)

                                        @if(in_array($fs->id,$existing_fasilitas))
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="{{ $fs->id }}" id="defaultCheck{{ $i }}" name="arr_fasilitas[]" {{ $checked_type }}>
                                            <label class="form-check-label" for="defaultCheck{{ $i }}">
                                                <img src="{{ asset($fs->imgicon) }}" alt="" height="15px">&nbsp {{ $fs->namaicon }}
                                            </label>
                                        </div>
                                        @endforeach
                                    </div>
