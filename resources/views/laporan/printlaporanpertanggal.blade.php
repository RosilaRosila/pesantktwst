    ...
    <div class="container">
        ...
        <div>
            <div class="content text-center mb-3">
                <p style="font-size: 15px; font-weight:bold">Laporan Pendapatan from &nbsp {{ Carbon\Carbon::parse($tanggalawal)->format('d-m-Y') }} &nbsp to &nbsp {{Carbon\Carbon::parse($tanggalakhir)->format('d-m-Y') }}</p>
            </div>
            <br>
