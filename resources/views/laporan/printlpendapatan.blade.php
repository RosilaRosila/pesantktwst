...
<body>
    ...
    <div class="container">
        ...
        <div>
            <div class="mb-3">
                <p style="font-size: 15px; font-weight:bold" class="mt-4">Kategoti Tiket : {{ $dataakhir->datatiket->namawst }}</p>
                <p style="font-size: 15px; font-weight:bold" class="mt-3">Laporan Pendapatan from &nbsp {{ Carbon\Carbon::parse($tanggalawal)->format('d-m-Y') }} &nbsp to &nbsp {{Carbon\Carbon::parse($tanggalakhir)->format('d-m-Y') }}</p>
            </div>
            <br>
