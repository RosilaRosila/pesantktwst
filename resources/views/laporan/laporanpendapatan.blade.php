            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola Laporan Pendapatan</h4>
                        <br>
                        <br>
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    <p class="card-header text-bold" style="font-size: 14px;">Print Laporan Berdasarkan Kategori Tiket dan Tanggal</p>
                                                    <br>
                                                    <form action="{{ route('print_laporan_pendapatan') }}" method="GET">
                                                        <div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    <p class="card-header text-bold" style="font-size: 14px;">Print Laporan Berdasarkan Tanggal</p>
                                                    <br>
                                                    <form action="{{ route('print-laporan_pertanggal') }}" method="GET">
                                                        <div>
                                                            <div class="w-250">
                                                                <label for="start_date" style="font-size: 12px;">Start Date:</label><br>
                                                                <input type="date" name="start_date" id="start_date" required class="form-control">
                                    ...
                                    <br>
                                    <br>
                                    <form method="GET" action="{{ route('index_laporan') }}" class="form-inline mb-3">
                                    ...
                                    <table class="table table-hover table-bordered text-sm">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                            <tr>
                                                <td class="text-right text-bold" colspan="5">Jumlah Pendapatan</td>
                                                <td class="text-center text-bold">{{ formatRupiah($jumlah_pendapatan) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
