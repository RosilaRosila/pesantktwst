            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola Pengunjung Mancanegara</h4>
                        <br>
                        <br>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-hover table-bordered text-sm">
                                        ...
                                        <tbody>
                                            @if($mancanegara->count() > 0)
                                            @foreach($mancanegara as $fs)
                                            <tr>
                                                <th style="text-align: center;">{{ $loop->iteration + ($mancanegara->currentPage() - 1) * $mancanegara->perPage() }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-bold">{{ $jumlah_wisatamanca }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <div>
                                        <div class="float-left" style="font-size: 12px; font-weight:bold">
                                            Showing
                                            {{ $mancanegara->firstItem() }}
                                            to
                                            {{ $mancanegara->lastItem() }}
                                            of
                                            {{ $mancanegara->total() }}
                                            entries
                                        </div>
                                        <div class="float-right">
                                            <!-- {{ $mancanegara->links() }} -->
                                            {!! $mancanegara->appends(Request::except('page'))->render() !!}
                                        </div>
                                    </div>
                                    <br>
                                    <br>
