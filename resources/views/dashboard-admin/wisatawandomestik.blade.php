            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola Pengunjung Domestik</h4>
                        <br>
                        <br>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-hover table-bordered text-sm">
                                        ...
                                        <tbody>
                                            @if($domestik->count() > 0)
                                            @foreach($domestik as $fs)
                                            <tr>
                                                <th style="text-align: center;">{{ $loop->iteration + ($domestik->currentPage() - 1) * $domestik->perPage() }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-bold">{{ $jumlah_wisatadomestik }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
                                    <div>
                                        ...
                                        <div class="float-right">
                                            <!-- {{ $domestik->links() }} -->
                                            {!! $domestik->appends(Request::except('page'))->render() !!}
                                        </div>
                                    </div>
                                    <br>
                                    <br>
