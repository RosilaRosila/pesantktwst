            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola Pendapatan</h4>
                        <br>
                        <br>
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-hover table-bordered text-sm">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($pendapatan as $fs)
                                            <tr>
                                                <th style="text-align: center;">{{ $loop->iteration + ($pendapatan->currentPage() - 1) * $pendapatan->perPage() }}</th>
                                    ...
                                    <div>
                                        ...
                                        <div class="float-right">
                                            <!-- {{ $pendapatan->links() }} -->
                                            {!! $pendapatan->appends(Request::except('page'))->render() !!}
                                        </div>
                                    </div>
                                    <br>
                                    <br>
