            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Kelola Pengunjung Masuk</h4>
                        <br>
                        <br>
                                ...
                                <div class="card-body table-responsive">
                                    <table class="table table-hover table-bordered text-sm">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($pengunjung as $fs)
                                            <tr>
                                                <th style="text-align: center;">{{ $loop->iteration + ($pengunjung->currentPage() - 1) * $pengunjung->perPage() }}</th>
                                    ...
                                    <div>
                                        ...
                                        <div class="float-right">
                                            <!-- {{ $pengunjung->links() }} -->
                                            {!! $pengunjung->appends(Request::except('page'))->render() !!}
                                        </div>
                                    </div>
                                    <br>
                                    <br>
