            ...
            <div class="content-header">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h4 class="m-0 text-dark">Data Tiket Masuk dan Belum Masuk Tempat Wisata</h4>
                        <br>
                        <br>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title"><b>Data Tiket Masuk</b></h5>
                                                    <h2 class="card-text" style="font-weight:bold;">{{ $jumlah_kehadiran }}</h2>
                                                    <br>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title"><b>Data Tiket Belum Masuk</b></h5>
                                                    <h2 class="card-text" style="font-weight:bold;">{{ $jumlah_unkehadiran }}</h2>
                                                    <br>
                                                    <a href="#" class="btn btn-primary">Go somewhere</a>
                                                </div>
                                            </div>
